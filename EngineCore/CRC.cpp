...
UINT32 hash::singletable_crc32c(UINT32 crc, const void *buf, size_t size)
{
...
UINT32 hash::crc32c_sb8_64_bit(UINT32 crc,
...
UINT32 hash::multitable_crc32c(UINT32 crc32c,
...
UINT32 hash::calculate_crc32c(UINT32 crc32c,
	const unsigned char *buffer,
	unsigned int length)
{
	if (length < 4) {
