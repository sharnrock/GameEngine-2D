    ...
    */
    ...
    public:
        ...
        */
		...
		/*!
		\brief Gets the width and height attributes in the image tag within the tileset
		KJS
		*/
		void getImageConstraints(int& width, int& height) const 
		{ 
			width = m_image_width; 
    ...
    private:
		...
		int m_image_width;  // these go with image in image_path: KJS
		int m_image_height; // these go with image in image_path
